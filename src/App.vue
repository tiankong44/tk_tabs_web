<template>
  <div id="building" :style="bgStyle">
    <div id="app">
        ...
        <el-main>
            ...
            <el-row>
              <el-col :span="16" :offset="5">
                <el-row>
                  <el-col
                    :span="cardSpan"
                    v-for="(tab, index) in this.tabList.records"
                    id="card"
                  >
                    <div
                      id="avatar"
          ...
          <div class="pageButton">
            <el-pagination
              ...
              :total="tabList.total"
              :background="true"
              :page-size="tabList.size"
              :page-count="tabList.pages"
      ...
      >
        <addTabView @closeDialog="closeDialog()" @getPublicTbas="getPublicTbas()"></addTabView>
      </el-dialog>
...
<script>
import { getStorage, setStorage, isPC } from "@/common/utils/tools.js";
