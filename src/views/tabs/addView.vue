          ...
          <el-col :span="12">
            <el-row>
              <el-form-item label="内网地址" prop="insideUrl">
                <el-input
                  placeholder="请输入内容"
                  v-model.trim="tab.insideUrl"
                  clearable
                  class="input-with-select"
                >
                  <el-select
                    v-model.trim="insideUrlPrefix"
                    slot="prepend"
                    placeholder="http://"
                    class="prefixSelect"
                  >
          ...
          <el-col :span="12">
            <el-row>
              <el-form-item label="外网地址" prop="externalUrl">
                <el-input
                  placeholder="请输入内容"
                  v-model.trim="tab.externalUrl"
                  clearable
                  class="input-with-select"
                >
                  <el-select
                    v-model.trim="externalUrlPrefix"
                    slot="prepend"
                    placeholder="http://"
                    class="prefixSelect"
                  >
  ...
  data() {
    ...
    return {
      ...
      rules: {
        ...
        insideUrl: [
          { required: true, message: "请输入应用内网地址", trigger: "blur" },
        ],
        externalUrl: [
          { required: true, message: "请输入应用外网地址", trigger: "blur" },
        ],
      },
    };
  },
