...
<template>
    <div class="addTabView">
        <el-form ref="form" :model="tab" label-width="80px">
            <div>
                <el-row>
                    <el-col :span="12">
                        <el-row>
                            <el-form-item label="应用类型">
                                <div>
                                    <el-select v-model.trim="tab.icon" filterable clearable placeholder="请选择"
                                        @change="setInconUrl()">
                                        <el-option v-for="item in appList" :key="item.id" :label="item.name"
                                            :value="item.icon">
                                        </el-option>
                                    </el-select>
                                </div>
                    ...
                    <el-col :span="12">
                        <el-row>
                            <el-form-item label="应用名称">
                                <el-input placeholder="请输入内容" v-model.trim="tab.appName" clearable>
                                </el-input>
                            </el-form-item>
                        </el-row>
                    </el-col>
                    <el-col :span="12">
                        <el-row>
                            <el-form-item label="应用描述">
                                <el-input placeholder="请输入内容" clearable v-model.trim="tab.appDesc">
                                </el-input>
                            </el-form-item>
                        </el-row>
                    </el-col>
                    ...
                    <el-col :span="12">
                        <el-row>
                            <el-form-item label="内网地址">
                                <el-input placeholder="请输入内容" v-model.trim="tab.insideUrl" clearable
                                    class="input-with-select">
                                    <el-select v-model.trim="insideUrlPrefix" slot="prepend" placeholder="http://"
                                        class="prefixSelect">
                    ...
                    <el-col :span="12">
                        <el-row>
                            <el-form-item label="外网地址">
                                <el-input placeholder="请输入内容" v-model.trim="tab.externalUrl" clearable
                                    class="input-with-select">
                                    <el-select v-model.trim="externalUrlPrefix" slot="prepend" placeholder="http://"
                                        class="prefixSelect">
                                        <el-option label="http://" value="http://"></el-option>
                                        <el-option label="https://" value="https://"></el-option>
                                    </el-select>
                        ...
                        <el-row>
                            <el-form-item label="是否隐私">
                                <div class="individualSwitch">
                                    <el-switch v-model.trim="tab.individual" active-color="#13ce66"
